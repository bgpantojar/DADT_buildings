...
##################################USER INTERACTION#############################
t0 = time.time()
data_folder = 'p4_DT_LOD_03_Petrigna_building'
...
if how2get_kp == 0 or how2get_kp == 4:
    opening_4points = main_op_detector(data_folder, images_path, bound_box, op_det_nn, cte_fil4=.02)
else:
...
DADT = op_projector(data_folder, images_path, keypoints_path, polyfit_path, intrinsic, poses, structure, how2get_kp, im1, opening_4points, ctes=[.0, .2, .3, .3], ray_int_method="casting")
