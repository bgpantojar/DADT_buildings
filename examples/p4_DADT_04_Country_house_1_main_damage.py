...
#mshrm_kp_path = '../../data/paper2_LOD3_models/ + data_folder + '/mshrm_kp/'
...
im1 = ('frame001620','frame002100','frame002580', 'frame002880')

#############USER CALLING FUNCTIONS

#Detector
if how2get_kp == 0 or how2get_kp == 4:
    opening_4points = main_op_detector(data_folder, images_path, bound_box, op_det_nn, cte_fil4=.05)
else:
...
crack_projector(DADT, data_folder, images_path, keypoints_path, intrinsic, poses, structure, im1, opening_4points, ray_int_method="casting", compute_kinematics=False, cracks2textured=True)#, extra_features = ["oop", "roof"])
